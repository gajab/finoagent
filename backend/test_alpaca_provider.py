...
async def test_alpaca():
    print("Testing Alpaca Provider Implementation...")
    # Requires ALPACA_API_KEY and ALPACA_API_SECRET set in the environment
    
    # If keys are missing, we expect a ValueError from AlpacaProvider's init
    try:
        provider = get_market_data_provider("alpaca")
